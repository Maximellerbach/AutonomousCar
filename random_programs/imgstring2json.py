...
def imgstring2donkeyjson_dos(src_dos, dst_dos):
    ...
    for path in tqdm(paths):
        ...
        annotation_dict = {"cam/image_array": new_img_name, "user/angle": direction, "user/throttle": 0.5}
...
def imgstring2json_dos(src_Dataset, dst_Dataset, src_dos, dst_dos):
    ...
    DatasetJson.imgstring2json_dos(DatasetImg, DatasetJson.imgstring2dict2json, src_dos + "\\", dst_dos + dos_name + "\\")


if __name__ == "__main__":

    DatasetImg = dataset_img.Dataset([dataset_img.direction_component, dataset_img.time_component])
    ...
    src_doss = ["C:\\Users\\maxim\\random_data\\2 donkeycar driving\\"]
