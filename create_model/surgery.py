...
from custom_modules.architectures import dir_loss
...
def forward(model, dos, show=True, index=None):
    prev = np.zeros((256))
    m = load_model("test_model\\models\\lightv5_mix.h5", custom_objects={"dir_loss":dir_loss})
...
if __name__ == "__main__":
    model = load_model("test_model\\models\\fe.h5", custom_objects={"dir_loss":dir_loss})
