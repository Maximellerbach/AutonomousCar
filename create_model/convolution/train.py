...
class classifier():
    ...
    def build_classifier(self, model_type, load=False):
        ...
        if load == True:
            ...
            model, fe = model_type((120, 160, 3), 5, loss="categorical_crossentropy", prev_act="relu", last_act="softmax", regularizer=(0.0, 0.05), last_bias=False, recurrence=self.recurrence, memory=self.memory_size, metrics=["categorical_accuracy", "mse"])
    ...
    def get_frc(self, dos): # TODO: add folder weights
        """
...
if __name__ == "__main__":
    AI = classifier(name = 'test_model\\convolution\\lightv6_mix.h5', dospath ='C:\\Users\\maxim\\datasets\\*',
                    recurrence=False, dosdir=True, proportion=0.2, to_cat=True, smoothing=0., label_rdm=0.) 
