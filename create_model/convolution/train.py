...
class classifier():
    ...
    def build_classifier(self, model_type, load=False):
        ...
        if load == True:
            ...
            model, fe = model_type((120, 160, 3), 5, loss="categorical_crossentropy", prev_act="relu", last_act="softmax", regularizer=(0.5, 0.0), last_bias=False, recurrence=self.recurrence, memory=self.memory_size, metrics=["categorical_accuracy", "mse"])
