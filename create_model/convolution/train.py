...
if __name__ == "__main__":
    AI = classifier(name = 'test_model\\convolution\\lightv6_mix.h5', dospath ='C:\\Users\\maxim\\datasets\\*',
                    recurrence=False, dosdir=True, proportion=0.5, to_cat=True, smoothing=0.2, label_rdm=0.) 
    ...
    AI.after_training_test_pred('C:\\Users\\maxim\\datasets\\7 sim normal\\*', (160,120), cut=0, from_path=True, from_vid=False, n=64, nimg_size=(4,4), sleeptime=1) # 'C:\\Users\\maxim\\datasets\\2\\*' 'C:\\Users\\maxim\\image_mix2\\*'
