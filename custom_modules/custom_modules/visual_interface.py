...
class AutoInterface:  # single interface object for 1 client
    def __init__(self, window, client_class, screen_size=(512, 512), name="Auto_0"):
        ...
        self.scale_default = self.client_class.PID_settings + [self.client_class.buffer_time]
    ...
    def add_interface(self):
        ...
        tkinter.Button(self.window, text="Respawn", command=self.respawn).grid(row=off_y, column=last_button)
        last_button += 1
        tkinter.Button(self.window, text="Terminate", command=self.client_class.terminate).grid(row=off_y, column=last_button)
        last_button += 1
        tkinter.Button(self.window, text="Reset to default", command=self.reset).grid(row=off_y, column=last_button)
        last_button += 1
        ...
        b = tkinter.Checkbutton(
            self.window, text="Transform st", variable=bvar, onvalue=True, offvalue=False, command=self.get_checkbox_value
        )
        ...
        bvar = tkinter.BooleanVar()
        b = tkinter.Checkbutton(
            self.window, text="Smooth", variable=bvar, onvalue=True, offvalue=False, command=self.get_checkbox_value
        )
        b.grid(row=off_y, column=last_button)
        last_button += 1
        self.bool_checkbox.append(bvar)
        ...
        bvar = tkinter.BooleanVar()
        b = tkinter.Checkbutton(
            self.window, text="Random", variable=bvar, onvalue=True, offvalue=False, command=self.get_checkbox_value
        )
        b.grid(row=off_y, column=last_button)
        last_button += 1
        self.bool_checkbox.append(bvar)
        ...
        bvar = tkinter.BooleanVar()
        b = tkinter.Checkbutton(
            self.window, text="Do_overide_st", variable=bvar, onvalue=True, offvalue=False, command=self.get_checkbox_value
        )
        b.grid(row=off_y, column=last_button)
        last_button += 1
        self.bool_checkbox.append(bvar)
        ...
        b = tkinter.Checkbutton(
            self.window, text="Record", variable=self.record_bool, onvalue=True, offvalue=False, command=self.get_record
        )
        b.grid(row=off_y, column=last_button)
        last_button += 1
        ...
        bvar = tkinter.BooleanVar()
        b = tkinter.Checkbutton(
            self.window, text="Stop", variable=bvar, onvalue=True, offvalue=False, command=self.get_checkbox_value
        )
        b.grid(row=off_y, column=last_button)
        last_button += 1
        self.bool_checkbox.append(bvar)
    ...
    def get_record(self, v=0):
        ...
        if (
            os.path.exists(self.client_class.default_dos)
            and self.client_class.record is False
            and len(glob(self.client_class.default_dos + "*")) == 0
        ):
